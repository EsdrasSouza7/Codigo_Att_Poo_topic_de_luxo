...
class TestTopic(unittest.TestCase):
    ...
    def testInicializacao(self):
        ...
        topic = Topic(10, 2)
        self.assertEqual(8, topic.getAssentosNormais(), "Quantidade errada de assentos comuns!")
        self.assertEqual(2, topic.getAssentosPrioritarios(), "Quantidade errada de assentos prioritários!")
